...
export default function PODetailPage() {
  ...
  if (!po) {
    return <div className="min-h-screen bg-slate-50 p-8 text-slate-500 text-sm">Purchase Order not found.</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-3xl mx-auto">
        ...
        {instance && (
          <>
            <h2 className="text-sm font-semibold text-slate-700 mb-3">Approval Chain</h2>
